   ...
   <div id="wrapper">
      ...
      <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
         ...
         <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= BASEURL; ?>">
            <div class="sidebar-brand-text">Management Gudang</div>
         </a>
         ...
         <!-- Nav Item - Dashboard -->
         <li class="nav-item <?= $data['url'] == 'dashboard' ? 'active' : '' ?>">
            <a class="nav-link" href="<?= BASEURL; ?>">
               <i class="fas fa-fw fa-tachometer-alt"></i>
               <span>Dashboard</span></a>
         </li>
         <li class="nav-item <?= $data['url'] == 'stock' ? 'active' : '' ?>">
            <a class="nav-link" href="<?= BASEURL; ?>/stock">
         ...
         <li class="nav-item">
            ...
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
               <div class="bg-white py-2 collapse-inner rounded">
                  <a class="collapse-item <?= $data['url'] == 'in' ? 'active' : '' ?>" href="<?= BASEURL; ?>/barang/in">Barang Masuk</a>
                  <a class="collapse-item <?= $data['url'] == 'out' ? 'active' : '' ?>" href="<?= BASEURL; ?>/barang/out">Barang Keluar</a>
               </div>
            </div>
         </li>
